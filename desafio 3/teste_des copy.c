...
void Heap(struct Algoritmo *sexto, int lista1[], int x) 
{
    ...
    while(true) {
        ...
        while (filha < x) {
            if ((filha + 1 < x) && (lista1[filha + 1] > lista1[filha])) {
                filha++;
                mov++;
                comp++;
            }
            if (lista1[filha] > j) {
                lista1[mae] = lista1[filha];
                mae = filha;
                filha = mae * 2 + 1;
                mov++;
                comp++;
...
void Bucket(struct Algoritmo *terceiro, int lista1[BK], int x) 
{
    FILE *Bucket_Test;
...
void Cocktail(struct Algoritmo *primeiro, int lista1[], int x)
{
    ...
    for (int h = 0; h < x; h++) {
        fprintf(Cocktail_Test, "%d|", lista1[h]);
    }
